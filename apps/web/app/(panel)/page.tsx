    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-400">
          Resumen del catálogo de música.
        </p>
      </div>

      {isLoading && <Spinner />}
      {error && <p className="text-sm text-red-300">No se pudo cargar el resumen.</p>}
      ...
      {data && (
        <>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <NavCard href="/tracks" title="Canciones" desc="Catálogo, alta por link y export a Excel." />
            <NavCard href="/playlists" title="Playlists" desc="Arma listas y usa el generador automático." />
            <NavCard href="/reports" title="Reportes" desc="Resumen del catálogo y más solicitadas." />
          </div>
        </>
      )}
    </div>
